...
table1 = [[1, 3, 'b'], [4, 2, 8], [7, 5, 6]] # Original
table1mod = [[1, 3, 'b'], [4, 2, 6], [7, 5, 8]] # Trocando 8 com o 6
table2 = [[5, 'b', 2], [1, 4, 3], [7, 8, 6]]
table3 = [['b', 2, 3], [1, 5, 6], [4, 7, 8]]

#initial_state = s.StateNode(g.Game8(table1), None, None, 0, 0) # Original
initial_state = s.StateNode(g.Game8(table1mod), None, None, 0, 0) # Trocando 8 com o 6
